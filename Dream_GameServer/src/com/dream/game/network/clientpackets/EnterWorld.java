...
import com.protect.GameGuardManager;
import com.protect.HWIDManager;
...
import com.protect.Spartan.RestrictionType;

import static com.protect.SpartanConfig.SESSION_FROM_SAME_PC;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			_log.info("[SpartanGuard]: New Login -> Account:["+  activeChar.getClient().getAccountName() +"]-> Character:["+  activeChar.getName() +"]-> HWID:["+ _client.getHWID() +"]");
		}
	...
	private void announceSystem(L2PcInstance activeChar)
	{
