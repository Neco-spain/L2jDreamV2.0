...
public class VipItem3 implements IItemHandler
{
	...
	public synchronized void useItem(L2Playable playable, L2ItemInstance item)
	{
		...
		else
		{
			...
			{
				player.setVip(true);
				player.setEndTime("vip", Config.VIP_DIAS3);
				player.sendMessage("Dear " + player.getName() + " now you have VIP Status " + " you have acess granted in VIPs NPC's," + " remember you have " + Config.VIP_DIAS3 + " VIP days.");
